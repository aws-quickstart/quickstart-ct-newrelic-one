...
of your AWS Control Tower managed landing zones with New Relic, right from the moment accounts are enrolled. You spend no time managing New Relic integration while automatically monitoring your AWS environment from New Relic.
